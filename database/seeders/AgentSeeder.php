    ...
    public function run(): void
    {
        ...
        $agents = [
            [
                ...
                'video_youtube_id' => 'agents/videos/default_support.mp4',
                'model_type' => 'GPT-4',
                'price' => 1.99,
            ],
            [
                ...
                'video_youtube_id' => 'agents/videos/default_tutor.mp4',
                'model_type' => 'GPT-3.5',
                'price' => 1.99,
            ],
            [
                ...
                'video_youtube_id' => 'agents/videos/default_financial.mp4',
                'model_type' => 'Claude',
                'price' => 1.99,
            ],
        ];

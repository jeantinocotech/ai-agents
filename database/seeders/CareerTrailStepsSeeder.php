    ...
    public function run(): void
    {
        $steps = [
            ...
            [
                ...
                'graca_guidance' => 'Aqui o foco é alinhar o seu CV com a vaga: palavras-chave, verbos de ação e clareza. Guarde a descrição da vaga (JD) na biblioteca do agente e peça sugestões concretas ao assistente.',
            ],
            [
                'slug' => 'cover-letter',
                'sort_order' => 3,
            ...
            [
                'slug' => 'offer',
                'sort_order' => 5,
                'title' => 'Avaliar e negociar proposta',
            ...
            [
                'slug' => 'first-100-days',
                'sort_order' => 6,
                'title' => 'Estratégia dos primeiros 100 dias',

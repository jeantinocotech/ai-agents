        ...
        <div class="mx-auto max-w-5xl sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
                ...
                <div class="mt-4 flex flex-wrap gap-2 text-xs">
                    ...
                    <button type="button" id="ats-toggle-table" class="rounded-md border border-slate-200 bg-white px-2 py-1 font-medium text-slate-700 hover:bg-slate-50">
                        Ver tabela completa
                    </button>
                </div>
                ...
                <div id="ats-focus-panel" class="mt-4 rounded-xl border border-indigo-100 bg-indigo-50/40 p-4">
                    ...
                    <div class="mt-3 flex flex-wrap gap-2">
                        <button type="button" id="ats-copy-suggestion" class="hidden rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-50">
                            Copiar sugestão
                        </button>
                        ...
                        <button type="button" id="ats-prev-item" class="rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700">← Anterior</button>
                        <button type="button" id="ats-next-item" class="rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700">Próxima →</button>
                    </div>
                </div>
            ...
            <form method="post" action="{{ route('career-trail.ats.workspace.cv', $analysis) }}" class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
                ...
                <div class="mt-4 flex flex-wrap gap-3">
                    <button type="submit" name="redirect" value="workspace"
                    ...
                    @if ($reanalyzeUrl)
                        <button type="submit" name="redirect" value="reanalyze"

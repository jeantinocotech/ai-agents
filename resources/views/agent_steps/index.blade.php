...
<div class="p-4">
    ...
    <a href="{{ route('agents.steps.create', $agent) }}" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block">Novo Passo</a>
            ...
            @foreach ($steps as $step)
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        <a href="{{ route('agents.steps.edit', [$agent, $step]) }}" class="text-blue-600">Editar</a> |
                        <form action="{{ route('agents.steps.destroy', [$agent, $step]) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')

                ...
                <div class="px-6 py-6">
                    <form method="post" action="{{ route('agents.motivation-letters.update', [$agent, $letter]) }}" class="space-y-5">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button type="submit" class="inline-flex items-center rounded-xl bg-violet-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-violet-700">Guardar alterações</button>

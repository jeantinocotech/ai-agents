        ...
        <div class="mx-auto max-w-3xl space-y-6 sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow-sm ring-1 ring-slate-200 sm:rounded-xl">
                <div class="border-b border-slate-100 bg-slate-50/80 px-6 py-5">
                    ...
                    @endif
                    <p class="mt-1 text-xs text-slate-500">A sequência e o processo (vaga) não são alteráveis aqui; crie um novo registo para outra ronda ou processo.</p>
                </div>
                ...
                <div class="px-6 py-6">
                    <form method="post" action="{{ route('agents.interview-preparations.update', [$agent, $prep]) }}" class="space-y-5">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button type="submit" class="inline-flex rounded-xl bg-violet-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-violet-700">Guardar</button>

    ...
    <div class="py-10">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <article class="rounded-xl bg-white p-8 shadow-sm ring-1 ring-gray-100">
                ...
                @include('legal.partials.terms-body', ['fromRegister' => $fromRegister, 'registerModal' => false])

                <div class="not-prose mt-10 flex flex-wrap gap-4 border-t border-gray-200 pt-6 text-sm">
